...
"use client"
import { faBook, faEye, faFilePen, faPenToSquare, faSquarePlus, faTrashCan } from "@fortawesome/free-solid-svg-icons"
...
const exams = [
    ...
    { id: 10, title: "English Exam", subject: "English", date: "2023-10-01", time: "10:00 AM", duration: "2 hours", status: "Scheduled" },
    { id: 11, title: "English Exam", subject: "English", date: "2023-10-01", time: "10:00 AM", duration: "2 hours", status: "Scheduled" },
]
            ...
            <div className="p-2 m-3">
                ...
                <div className="">
                    ...
                    <div className="flex items-center justify-between mt-4">
                        <h1 className="text-lg ml-1 hidden md:block">Exams ( {exams.length} )</h1>
                        <a href="#my_modal_8" className="btn btn-soft ml-10 mr-3">
