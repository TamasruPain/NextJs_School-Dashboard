            ...
            <div>
                ...
                <div className="backdrop-blur-xl font-bold text-black rounded-box w-xs hover:shadow-md shadow-sky-400">
                    <fieldset className="fieldset p-5">
                        <legend className="fieldset-legend text-2xl mb-8">Teachers Login</legend>
                        <div>
                        ...
                        <Link href={"/Teacher-Dashboard/teacher"} className="btn btn-outline btn-ghost mt-2 mb-5 hover:shadow-md shadow-green-200">
                            Login
                        </Link>
