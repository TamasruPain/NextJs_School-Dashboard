...
import { faBook, faBullhorn, faCalendarCheck, faChalkboard, faCircleUser, faCommentDots, faFilePen, faGear, faHouse, faListCheck, faPeopleRoof, faScroll, faUsers } from "@fortawesome/free-solid-svg-icons"
...
const menuItems = [
    {
        ...
        titleHref: "/Teacher-Dashboard/teacher-profile",
        items: [
            {
            ...
            },
            {
                ...
                label: "Messages",
                href: "/Teacher-Dashboard/manage-messages"
            },
            {
                icon: <FontAwesomeIcon icon={faBullhorn} style={{ color: "#B197FC", }} />,
                label: "Announcements",
                href: "/Teacher-Dashboard/manage-announcements"
            },
        ]
    }
]
